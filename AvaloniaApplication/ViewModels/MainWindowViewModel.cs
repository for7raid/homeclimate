...
namespace AvaloniaApplication.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public DayInfoViewModel DayInfo { get; set; } = new DayInfoViewModel();
...
#if DEBUG
                var text = await System.IO.File.ReadAllTextAsync(@"C:\Users\for7r\Documents\Visual Studio 2017\Projects\homeclimate\AvaloniaApplication\forecast.json");
#else
...
#endif
                Forecasts.Clear();
                var forecast = JsonSerializer.Deserialize<Models.YandexMeteo>(text);
